...
-- Truncating data if exists before inserting
-- Cleaning query and inserting of bronze.crm_cust_info
...
-- Truncating data if exists before inserting
-- Cleaning query and inserting of bronze.crm_prd_info
...
-- Truncating data if exists before inserting
-- Cleaning query and inserting of bronze.crm_sales_details
...
-- Truncating data if exists before inserting
-- Cleaning query and inserting of bronze.erp_cust_az12
...
-- Truncating data if exists before inserting
-- Cleaning query and inserting of bronze.erp_loc_a101
...
-- Truncating data if exists before inserting
-- Cleaning query and inserting of bronze.erp_px_cat_g1v2
